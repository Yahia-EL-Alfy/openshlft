...
export class ReserveComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.http.get<User[]>('https://backend-git-yahia-elalfy-dev.apps.sandbox-m4.g2pi.p1.openshiftapps.com/getdoctors').subscribe((data) => {
      this.doctors = data;
    });
  }
  ...
  onSelectedDoctorChange() {
    ...
    if (this.selectedDoctor) {
      this.http.get<Slot[]>('https://backend-git-yahia-elalfy-dev.apps.sandbox-m4.g2pi.p1.openshiftapps.com/getdoctorslots?doctor_id=' + this.selectedDoctor).subscribe((data) => {
